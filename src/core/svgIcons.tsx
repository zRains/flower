export interface BasicSvgProps extends React.SVGProps<SVGSVGElement> {}

export function ArrowDownIcon(props: BasicSvgProps) {
  return (
...
export function DeleteIcon(props: BasicSvgProps) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
      <path
        fill="currentColor"
...
export function PlusIcon(props: BasicSvgProps) {
  return (
    <svg {...props} viewBox="64 64 896 896" width="1em" height="1em" fill="currentColor">
...
export function BanIcon(props: BasicSvgProps) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
      <path
        fill="currentColor"
...
export function MoreIcon(props: BasicSvgProps) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
      <path
        fill="currentColor"
...
interface ApiServiceIconProps extends BasicSvgProps {}
...
interface EndIconProps extends BasicSvgProps {}
...
interface MessageIconProps extends BasicSvgProps {}
...
interface StartIconProps extends BasicSvgProps {}
...
export function EditIcon(props: BasicSvgProps) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
      <path
        fill="currentColor"
...
export function CloseIcon(props: BasicSvgProps) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
      <path
        fill="currentColor"
