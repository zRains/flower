...
import style from './null.node.module.less'

interface NullNodeProps extends NodeProps {}

export default memo(function NullNode(props: NullNodeProps) {
  return (
    <div className={style['null-node-wrapper']}>
      <div className="node-selected-halo"></div>
      <div>
        <svg
          className="null-node-label-icon"
